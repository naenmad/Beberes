...
export default function AboutModal() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="relative p-6 text-center border-b border-black/4 dark:border-white/6 bg-linear-to-b from-accent/5 to-transparent">
          <button
            type="button"
            onClick={closeAboutModal}
          ...
          <img
            ...
            alt="Beberes"
            className="w-16 h-16 rounded-2xl object-cover mx-auto shadow-lg shadow-accent/20 mb-3"
          />
